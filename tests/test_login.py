...
class TestLogin:
    ...
    def test_login_with_invalid_user_valid_password(self, page: Page):
        logger.info(f"Starting test: {inspect.currentframe().f_code.co_name}")
    ...
    def test_login_with_valid_user_invalid_password(self, page: Page):
        logger.info(f"Starting test: {inspect.currentframe().f_code.co_name}")
    ...
    def test_login_with_invalid_user_and_invalid_password(self, page: Page):
        logger.info(f"Starting test: {inspect.currentframe().f_code.co_name}")
